...
Every file you track, every commit you make, are snapshots that live in one place: `git`'s `objects` database.

In this post, we'll discuss the general anatomy of [Git objects](https://git-scm.com/book/en/v2/Git-Internals-Git-Objects), and how
