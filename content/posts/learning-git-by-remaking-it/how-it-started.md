...
A couple of years ago, I read [this great article](https://octobot.medium.com/how-git-internally-works-1f0932067bee)
...
`writing git from scratch` into a search bar and stumbled upon the amazing [Write yourself a Git!](https://wyag.thb.lt/)
article, written by [Thibault Polge](https://github.com/thblt), and everyone else who contributed as well.

I immediately jumped onto that article to open it, and eventually found myself reading it all and following along. And I
thought it'd be a good idea to give back and share what I learned in my own words.
